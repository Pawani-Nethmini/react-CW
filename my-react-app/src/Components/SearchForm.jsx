...
function SearchForm({ onSearch }) {
  ...
  const submit = (e) => {
    ...
    let minBeds=form.minBeds ? Number(form.minBeds) : 1;
    let maxBeds=form.maxBeds ? Number(form.maxBeds) : 5;

    minBeds=Math.min(Math.max(minBeds, 1), 4);
    maxBeds=Math.min(Math.max(maxBeds, 2), 5);
